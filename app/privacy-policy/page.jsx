...
import { ArrowLeft, Shield, Database, Eye, Users, Lock, Share2, CheckCircle, Mail } from 'lucide-react'
import { privacyData } from '@/lib/mockData'
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-20">
        ...
        <div ref={heroRef} className="relative max-w-4xl mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            This Privacy Policy explains how Neptunes Tech collects, uses, and protects 
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  At NEPTUNES TECH, we are committed to protecting your privacy and ensuring 
                  the security of your personal information. We continuously review and update 
                  our practices to maintain the highest standards of data protection.
                </p>
              </div>
            </div>
          </div>
